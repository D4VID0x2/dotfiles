...
# main packages
yay -Sy vim neovim tmux zsh bat gparted gimp htop libreoffice-fresh wireshark-qt chromium discord vlc stow exa thefuck xclip gdb cgdb gvfs-goa thunar-archive-plugin dust tree --needed --noconfirm
